...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (navbarPlaceholder) {
      ...
      // Configure it to fetch navbar.html
    ...
    fetch("./portfolio/portfolioData.json")
      ...
      .then((data) => {
        data.projects.forEach((project) => {
          ...
          projectContent.classList.add("portfolio-content", "h-100");
          ...
          projectInfo.classList.add("portfolio-info");
          ...
          projectLink.title = "More details";
          projectLink.classList.add("details-link");
          projectLink.innerHTML = '<i class="bi bi-link-45deg">';
          projectLink.href = `portfolio-details.html?projectKey=${project.key}`;
